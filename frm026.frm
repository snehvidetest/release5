...
Public Sub OKButton_Click()
    ...
    If Not (Forfaldsdato Or SRB Or Stiftelsesdato Or PeriodeStartdato Or PeriodeSlutdato) Then
        dFunc.msgError = "Vælg som minimum et stamdatofelt for at gå videre"
        SFunc.ShowFunc ("frmMsg")
        Exit Sub
    End If

     ' Validering af at PeriodeSlutdato er udfyldt

     If Forfaldsdato.Value = True And txtFFStart.Value = "" Then
        dFunc.msgError = "Startdatoen skal udfyldes for at forsætte."
        SFunc.ShowFunc ("frmMsg")
        GoTo ending
    End If

     If SRB.Value = True And txtSRBstart.Value = "" Then
        dFunc.msgError = "Startdatoen skal udfyldes for at forsætte."
        SFunc.ShowFunc ("frmMsg")
        GoTo ending
    End If

     If Stiftelsesdato.Value = True And txtSTIstart.Value = "" Then
        dFunc.msgError = "Startdatoen skal udfyldes for at forsætte."
        SFunc.ShowFunc ("frmMsg")
        GoTo ending
    End If

     If PeriodeStartdato.Value = True And txtPSTstart.Value = "" Then
        dFunc.msgError = "Startdatoen skal udfyldes for at forsætte."
        SFunc.ShowFunc ("frmMsg")
        GoTo ending
    End If

     If PeriodeSlutdato.Value = True And txtPSLstart.Value = "" Then
        dFunc.msgError = "Startdatoen skal udfyldes for at forsætte."
        SFunc.ShowFunc ("frmMsg")
        GoTo ending
    End If
    ...
    Call writeSpmSvar("4.a.2.1", Controls("Label1").caption, "")
...
'        Worksheets("SpmSvar").Range("F8:F8").Value = txtFFSlut
        Call writeSpmSvar("4.a.2.1_1", Forfaldsdato.caption, txtFFStart, txtFFSlut)
    Else
...
'        Worksheets("SpmSvar").Range("F9:F9").Value = txtSRBslut
        Call writeSpmSvar("4.a.2.1_2", SRB.caption, txtSRBstart, txtSRBslut)
    Else
...
'        Worksheets("SpmSvar").Range("F10:F10").Value = txtSTIslut
        Call writeSpmSvar("4.a.2.1_3", Stiftelsesdato.caption, txtSTIstart, txtSTIslut)
    Else
...
'        Worksheets("SpmSvar").Range("F11:F11").Value = txtPSTslut
        Call writeSpmSvar("4.a.2.1_4", PeriodeStartdato.caption, txtPSTstart, txtPSTslut)
    Else
...
'        Worksheets("SpmSvar").Range("F12:F12").Value = txtPSLslut
        Call writeSpmSvar("4.a.2.1_5", PeriodeSlutdato.caption, txtPSLstart, txtPSLslut)
    Else
...
If findPreviousAns(findTopSpm("F"), "4.a.2.1_1", 1) <> "" Then
    ...
    txtFFStart = findPreviousAns(findTopSpm("F"), "4.a.2.1_1", 1)
    txtFFSlut = findPreviousAns(findTopSpm("F"), "4.a.2.1_1", 2)
End If

If findPreviousAns(findTopSpm("F"), "4.a.2.1_2", 1) <> "" Then
    Call SRB_Click
    SRB.Value = True
    txtSRBstart = findPreviousAns(findTopSpm("F"), "4.a.2.1_2", 1)
    txtSRBslut = findPreviousAns(findTopSpm("F"), "4.a.2.1_2", 2)
End If

If findPreviousAns(findTopSpm("F"), "4.a.2.1_3", 1) <> "" Then
    Call Stiftelsesdato_Click
    Stiftelsesdato.Value = True
    txtSTIstart = findPreviousAns(findTopSpm("F"), "4.a.2.1_3", 1)
    txtSTIslut = findPreviousAns(findTopSpm("F"), "4.a.2.1_3", 2)
End If

If findPreviousAns(findTopSpm("F"), "4.a.2.1_4", 1) <> "" Then
    Call PeriodeStartdato_Click
    PeriodeStartdato.Value = True
    txtPSTstart = findPreviousAns(findTopSpm("F"), "4.a.2.1_4", 1)
    txtPSTslut = findPreviousAns(findTopSpm("F"), "4.a.2.1_4", 2)
End If

If findPreviousAns(findTopSpm("F"), "4.a.2.1_5", 1) <> "" Then
    Call PeriodeSlutdato_Click
    PeriodeSlutdato.Value = True
    txtPSLstart = findPreviousAns(findTopSpm("F"), "4.a.2.1_5", 1)
