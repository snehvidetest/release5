...
Call writeSpmSvar("4.a.1", Controls("Label1").caption, TextBox1.Value, TextBox2.Value)
...
Else
    TextBox1.Value = findPreviousAns(findTopSpm("F"), "4.a.1", 1) 'Worksheets("SpmSvar").Range("D4:D4").Value
End If
