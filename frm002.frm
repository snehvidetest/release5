...
Call writeSpmSvar(1, Controls("Label1").caption, txtFordringsId.Value)
Call writeSpmSvar(2, Controls("Label2").caption, cboFordringstype.Value)
Call writeSpmSvar(3, Controls("spg3").caption, txtModtStart.Value, txtModtSlut.Value)
Call writeSpmSvar(4, Controls("Label5").caption, ans4)
...
txtFordringsId.Value = findPreviousAns(findTopSpm("F"), "1", 1)
cboFordringstype.Value = findPreviousAns(findTopSpm("F"), "2", 1)

txtModtStart.Value = findPreviousAns(findTopSpm("F"), "3", 1)
...
txtModtSlut.Value = findPreviousAns(findTopSpm("F"), "3", 2)
...
forkertData.Value = False
korrektData.Value = False
If findPreviousAns(findTopSpm("F"), "4", 1) = "Ja" Then
    forkertData.Value = True
