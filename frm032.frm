...
If OptionButton1.Value = True Then
    Call writeSpmSvar("10.a_2", Controls("Label3").caption, Controls("OptionButton1").caption)
Else
    Call writeSpmSvar("10.a_2", Controls("Label3").caption, Controls("OptionButton2").caption)
End If

If TextBox1.Value <> "" Then
    'Worksheets("SpmSvar").Range("D72:D72").Value = CInt(TextBox1.Value)
    If OptionButton1.Value = True Then
        Call writeSpmSvar("10.a.1_2", Controls("Label1").caption, CInt(TextBox1.Value))
    ElseIf OptionButton2.Value = True Then
        Call writeSpmSvar("10.a.2_2", Controls("Label7").caption, CInt(TextBox1.Value))
    End If
End If
If TextBox2.Value <> "" Then
    'Worksheets("SpmSvar").Range("D73:D73").Value = CInt(TextBox2.Value)
    If OptionButton1.Value = True Then
        Call writeSpmSvar("10.a.1.1_2", Controls("Label4").caption, CInt(TextBox2.Value))
    ElseIf OptionButton2.Value = True Then
        Call writeSpmSvar("10.a.2.1_2", Controls("Label4").caption, CInt(TextBox2.Value))
    End If
End If
...
If CheckBox1.Value = True Then
    ...
    If OptionButton1.Value = True Then
        Call writeSpmSvar("10.a.1_2", Controls("Label1").caption, "Ved ikke")
    ElseIf OptionButton2.Value = True Then
        Call writeSpmSvar("10.a.2_2", Controls("Label7").caption, "Ved ikke")
    End If
End If
...
If CheckBox2.Value = True Then
    ...
    If OptionButton1.Value = True Then
        Call writeSpmSvar("10.a.1.1_2", Controls("Label4").caption, "Ved ikke")
    ElseIf OptionButton2.Value = True Then
        Call writeSpmSvar("10.a.2.1_2", Controls("Label4").caption, "Ved ikke")
    End If
End If
...
If findPreviousAns(findTopSpm("F"), "10.a_2", 1) = "Samme dag eller senere end det valgte stamdatafelt" Then
    OptionButton2.Value = True
ElseIf findPreviousAns(findTopSpm("F"), "10.a_2", 1) = "Før det valgte stamdatafelt" Then
    OptionButton1.Value = True
End If

If OptionButton1.Value Then
    If findPreviousAns(findTopSpm("F"), "10.a.1_2", 1) = "Ved ikke" Then
        CheckBox1.Value = True
    Else
        TextBox1.Value = findPreviousAns(findTopSpm("F"), "10.a.1_2", 1)
    End If
    If findPreviousAns(findTopSpm("F"), "10.a.1_2", 1) = "Ved ikke" Then
        CheckBox1.Value = True
    Else
        TextBox1.Value = findPreviousAns(findTopSpm("F"), "10.a.1_2", 1)
    End If
    If findPreviousAns(findTopSpm("F"), "10.a.1.1_2", 1) = "Ved ikke" Then
        CheckBox2.Value = True
    Else
        TextBox2.Value = findPreviousAns(findTopSpm("F"), "10.a.1.1_2", 1)
        If findPreviousAns(findTopSpm("F"), "10.a.1.1_2", 1) = "1095" Then
...
ElseIf OptionButton2.Value Then
    If findPreviousAns(findTopSpm("F"), "10.a.2_2", 1) = "Ved ikke" Then
        CheckBox1.Value = True
    Else
        TextBox1.Value = findPreviousAns(findTopSpm("F"), "10.a.2_2", 1)
    End If
    If findPreviousAns(findTopSpm("F"), "10.a.2.1_2", 1) = "Ved ikke" Then
        CheckBox2.Value = True
    Else
        TextBox2.Value = findPreviousAns(findTopSpm("F"), "10.a.2.1_2", 1)
        If findPreviousAns(findTopSpm("F"), "10.a.1.1_2", 1) = "1095" Then
            CheckBox3.Value = True
            TextBox2.Enabled = False
        End If
