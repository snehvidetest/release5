...
End If
Call writeSpmSvar("10", Controls("Label5").caption, "")
If Forfaldsdato.Value = True Then
    ...
    Call writeSpmSvar("10_1", "Forfaldsdato", "Kan anvendes")
...
If Stiftelsesdato.Value = True Then
    ...
    Call writeSpmSvar("10_3", "Stiftelsesdato", "Kan anvendes")
...
If SRB.Value = True Then
    ...
    Call writeSpmSvar("10_2", "Sidste rettidige betalingsdato", "Kan anvendes")
...
If CheckBox2.Value = True Then
    ...
    Call writeSpmSvar("10_6", "Ingen", "Kan anvendes")
ElseIf CheckBox2.Value = False Then
...
End If
If findPreviousAns(findTopSpm("F"), "10_2", 1) <> "" Then
    SRB.Value = True
End If
If findPreviousAns(findTopSpm("F"), "10_3", 1) <> "" Then
    Stiftelsesdato.Value = True
End If
If findPreviousAns(findTopSpm("F"), "10_4", 1) <> "" Then
    PeriodeStartdato.Value = True
End If
If findPreviousAns(findTopSpm("F"), "10_5", 1) <> "" Then
    PeriodeSlutdato.Value = True
End If
If findPreviousAns(findTopSpm("F"), "10_6", 1) <> "" Then
