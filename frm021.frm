...
' Validering - Beløbsfeltet skal være udfyldt, eller 'Ved ikke' valgt ovenfor
    ...
    If CheckBox1.Value = True Then
        ...
        Call writeSpmSvar("12", Controls("Label2").caption, "Ved ikke")
    ...
    Else
        ...
        Call writeSpmSvar("12", Controls("Label2").caption, TextBox1.Value, "kr.")
...
ElseIf findPreviousAns(findTopSpm("F"), "12", 1) <> "" Then
    TextBox1.Value = findPreviousAns(findTopSpm("F"), "12", 1)
End If
