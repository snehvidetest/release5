...
Call writeSpmSvar("9.b.2.2", Controls("Label1").caption, TextBox1.Value)
End If

If OptionButton2.Value = True Then
'Worksheets("SpmSvar").Range("D23:D23").Value = "Ved ikke"
Call writeSpmSvar("9.b.2.2", Controls("Label1").caption, "Ved ikke")
End If
...
Me.Hide 'go back to previously stored form#
Call goBack
...
If IsNumeric(findPreviousAns(findTopSpm("F"), "9.b.2.2", 1)) Then
    ...
    TextBox1.Value = findPreviousAns(findTopSpm("F"), "9.b.2.2", 1)
ElseIf findPreviousAns(findTopSpm("F"), "9.b.2", 1) = "Ved ikke" Then
