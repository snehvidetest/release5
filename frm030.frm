...
If OptionButton1.Value = True Then
    Call writeSpmSvar("10.a_4", Controls("Label3").caption, Controls("OptionButton1").caption)
Else
    Call writeSpmSvar("10.a_4", Controls("Label3").caption, Controls("OptionButton2").caption)
End If
...
If TextBox1.Value <> "" Then
    ...
    ElseIf OptionButton2.Value = True Then
        Call writeSpmSvar("10.a.2_4", Controls("Label7").caption, CInt(TextBox1.Value))
    End If
End If
...
If CheckBox1.Value = True Then
    ...
    ElseIf OptionButton2.Value = True Then
        Call writeSpmSvar("10.a.2_4", Controls("Label7").caption, "Ved ikke")
    End If
End If
...
ElseIf findPreviousAns(findTopSpm("F"), "10.a_4", 1) = "Før det valgte stamdatafelt" Then
...
ElseIf OptionButton2.Value Then
    If findPreviousAns(findTopSpm("F"), "10.a.2_4", 1) = "Ved ikke" Then
        CheckBox1.Value = True
    Else
        TextBox1.Value = findPreviousAns(findTopSpm("F"), "10.a.2_4", 1)
    End If
    If findPreviousAns(findTopSpm("F"), "10.a.2.1_4", 1) = "Ved ikke" Then
        CheckBox2.Value = True
    Else
