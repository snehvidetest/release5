...
If OptionButton1.Value = True Then
    ...
    Call writeSpmSvar("9.a.2", Controls("Label1").caption, "Ja")
...
ElseIf OptionButton1.Value = False Then
    ...
    Call writeSpmSvar("9.a.2", Controls("Label1").caption, "Nej")
...
If findPreviousAns(findTopSpm("F"), "9.a.2", 1) = "Ja" Then
    OptionButton1.Value = True
ElseIf findPreviousAns(findTopSpm("F"), "9.a.2", 1) = "Nej" Then
